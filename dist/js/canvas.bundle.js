...
var Player = /*#__PURE__*/function () {
  ...
  _createClass(Player, [{
    ...
    value: function update() {
      ...
      if (this.position.y + this.height + this.velocity.y <= canvas.height) this.velocity.y += gravity; //else
      //   this.velocity.y = 0
    }
  }]);
...
var Platform = /*#__PURE__*/function () {
  function Platform(_ref) {
    ...
    this.image = image; //this.width = image.width
...
function init() {
  ...
  platforms = [new Platform({
    x: -1,
    y: 470,
    image: creatImage(_img_platform_png__WEBPACK_IMPORTED_MODULE_0__["default"])
  }), new Platform({
    x: 577,
    y: 470,
    image: creatImage(_img_platform_png__WEBPACK_IMPORTED_MODULE_0__["default"])
    ...
    x: 5 * 577 - 291,
    y: 245,
    image: creatImage(_img_platformSmallTall_png__WEBPACK_IMPORTED_MODULE_3__["default"])
  }), new Platform({
    x: 5 * 577 + 600,
    y: 470,
    image: creatImage(_img_platform_png__WEBPACK_IMPORTED_MODULE_0__["default"])
  ...
  genericObjects = [new GenericObject({
    x: -1,
    y: -1,
    image: creatImage(_img_background_png__WEBPACK_IMPORTED_MODULE_2__["default"])
  }), new GenericObject({
    x: -1,
    y: -1,
    image: creatImage(_img_hills_png__WEBPACK_IMPORTED_MODULE_1__["default"])
  })];
  scrollOffset = 0;
}
...
function animate() {
  ...
  c.fillStyle = "white";
  c.fillRect(0, 0, canvas.width, canvas.height); //c.clearRect(0, 0, canvas.width, canvas.height)
